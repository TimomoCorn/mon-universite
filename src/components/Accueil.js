...
const Accueil = () => {
  return (
    <div className="p-4">
      ...
      <ul className="mt-4">
        <li>
          <a href="/etudiants" className="text-blue-200 hover:text-white">
            Etudiants
          </a>
        </li>
        <li>
          <a href="/enseignants" className="text-blue-200 hover:text-white">
            Enseignants
          </a>
        </li>
        <li>
          <a href="/matieres" className="text-blue-200 hover:text-white">
            Matières
          </a>
        </li>
        <li>
          <a href="/notes" className="text-blue-200 hover:text-white">
            Notes
          </a>
        </li>
      </ul>
